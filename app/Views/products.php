...
<form method="get" action="" style="float: right;" class="form-inline my-2 my-lg-0">
    <input name="search" class="form-control mr-sm-2" type="search" placeholder="<?= hs(trans('products.searchBtn')); ?>" aria-label="Search">
    <input class="btn btn-primary my-2 my-sm-0" type="submit" value="<?= hs(trans('products.searchBtn')); ?>">
</form>
                    ...
                    <div class="card h-100" style="width: 250px;">
                        ...
                        <div class="card-footer bg-white text-center">
                            <form method="post" action="add_item" class="w-100">
                                ...
                                <input type="submit" class="btn btn-light w-100 rounded-pill fw-bold border border-dark" value="<?= hs(trans('products.addToCartBtn')); ?>">
                            </form>
                        </div>
