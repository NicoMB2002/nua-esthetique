                ...
                <?php } else { ?>
                    ...
                    <?php for ($j = $i * 6; $j < $i * 6 + 6; $j++):
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card mb-3" style="max-width: 540px;  width:250px;" >
                                    ...
                                    <div class="col-md-4"  >
                                        <img
                                            ...
                                            class="card-img-top"
                                            alt="<?= hs($product['name'] . "") ?>"
                                            style="height: 100px; width:225px; float: left;  object-fit: cover;">
                                    </div>
                                    <div class="col-md-8">
                                        ...
                                        <div class="card-footer" style="width:225px;">

                                            <form method="post" action="add_item" >
                                                <input type="hidden" name="id" value='<?= $product['product_id'] ?>'>
                                                <input style="" type="submit" class="btn btn-success btn-sm" value="Buy Now">
                                            </form>
                                        </div>
